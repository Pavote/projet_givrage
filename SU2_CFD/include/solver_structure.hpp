...
/*!
 * \class CImpactSolver
 * \brief Main class for defining the droplet impact solver.
 * \ingroup Euler_Equations
 * \author B. Constant, M. Fleurotte, A. Motte, I. Moufid
 */
class CImpactSolver : public CSolver {
protected:
...
public:
   ...
   * \param[in] config - Definition of the particular problem.
   */
  CImpactSolver(CGeometry *geometry, CConfig *config, unsigned short iMesh);

  /*!
   * \brief Destructor of the class.
   */
  virtual ~CImpactSolver(void);
  ...
  void BC_Sym_Plane_old(CGeometry *geometry, CSolver **solver_container, CNumerics *conv_numerics, CNumerics *visc_numerics, CConfig *config, unsigned short val_marker);
