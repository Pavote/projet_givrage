...
inline void CImpactVariable::SetSolution_New(void) {
  for (unsigned short iVar = 0; iVar < nVar; iVar++)
    Solution_New[iVar] = Solution[iVar];
}

inline void CImpactVariable::AddSolution_New(unsigned short val_var, su2double val_solution) {
  Solution_New[val_var] += val_solution;
}

inline su2double CImpactVariable::GetDensity(void) { return Solution[0]; }

inline su2double CImpactVariable::GetEnergy(void) { return Solution[nVar-1]/Solution[0]; };

inline su2double CImpactVariable::GetEnthalpy(void) { return Primitive[nDim+3]; }

inline su2double CImpactVariable::GetPressure(void) { return Primitive[nDim+1]; }

inline su2double CImpactVariable::GetSoundSpeed(void) { return Primitive[nDim+4]; }

inline su2double CImpactVariable::GetTemperature(void) { return Primitive[0]; }

inline su2double CImpactVariable::GetVelocity(unsigned short val_dim) { return Primitive[val_dim+1]; }
...
inline bool CImpactVariable::SetTemperature(su2double temperature) {
  Primitive[0] = temperature;
  if (Primitive[0] > 0.0) return false;
  else return true;
}

inline void CImpactVariable::SetdPdrho_e(su2double dPdrho_e) {
  Secondary[0] = dPdrho_e;
}

inline void CImpactVariable::SetdPde_rho(su2double dPde_rho) {
  Secondary[1] = dPde_rho;
}

inline su2double CImpactVariable::GetPrimitive(unsigned short val_var) { return Primitive[val_var]; }

inline void CImpactVariable::SetPrimitive(unsigned short val_var, su2double val_prim) { Primitive[val_var] = val_prim; }

inline void CImpactVariable::SetPrimitive(su2double *val_prim) {
  for (unsigned short iVar = 0; iVar < nPrimVar; iVar++)
    Primitive[iVar] = val_prim[iVar];
}

inline su2double *CImpactVariable::GetPrimitive(void) { return Primitive; }

inline su2double CImpactVariable::GetSecondary(unsigned short val_var) { return Secondary[val_var]; }

inline void CImpactVariable::SetSecondary(unsigned short val_var, su2double val_secondary) { Secondary[val_var] = val_secondary; }

inline void CImpactVariable::SetSecondary(su2double *val_secondary) {
  for (unsigned short iVar = 0; iVar < nSecondaryVar; iVar++)
    Secondary[iVar] = val_secondary[iVar];
}

inline su2double *CImpactVariable::GetSecondary(void) { return Secondary; }

inline void CImpactVariable::SetVelocity_Old(su2double *val_velocity) {
  for (unsigned short iDim = 0; iDim < nDim; iDim++)
    Solution_Old[iDim+1] = val_velocity[iDim]*Solution[0];
}

inline void CImpactVariable::AddGradient_Primitive(unsigned short val_var, unsigned short val_dim, su2double val_value) { Gradient_Primitive[val_var][val_dim] += val_value; }

inline void CImpactVariable::SubtractGradient_Primitive(unsigned short val_var, unsigned short val_dim, su2double val_value) { Gradient_Primitive[val_var][val_dim] -= val_value; }

inline su2double CImpactVariable::GetGradient_Primitive(unsigned short val_var, unsigned short val_dim) { return Gradient_Primitive[val_var][val_dim]; }

inline su2double CImpactVariable::GetLimiter_Primitive(unsigned short val_var) { return Limiter_Primitive[val_var]; }

inline void CImpactVariable::SetGradient_Primitive(unsigned short val_var, unsigned short val_dim, su2double val_value) { Gradient_Primitive[val_var][val_dim] = val_value; }

inline void CImpactVariable::SetLimiter_Primitive(unsigned short val_var, su2double val_value) { Limiter_Primitive[val_var] = val_value; }

inline su2double **CImpactVariable::GetGradient_Primitive(void) { return Gradient_Primitive; }

inline su2double *CImpactVariable::GetLimiter_Primitive(void) { return Limiter_Primitive; }

inline void CImpactVariable::AddGradient_Secondary(unsigned short val_var, unsigned short val_dim, su2double val_value) { Gradient_Secondary[val_var][val_dim] += val_value; }

inline void CImpactVariable::SubtractGradient_Secondary(unsigned short val_var, unsigned short val_dim, su2double val_value) { Gradient_Secondary[val_var][val_dim] -= val_value; }

inline su2double CImpactVariable::GetGradient_Secondary(unsigned short val_var, unsigned short val_dim) { return Gradient_Secondary[val_var][val_dim]; }

inline su2double CImpactVariable::GetLimiter_Secondary(unsigned short val_var) { return Limiter_Secondary[val_var]; }

inline void CImpactVariable::SetGradient_Secondary(unsigned short val_var, unsigned short val_dim, su2double val_value) { Gradient_Secondary[val_var][val_dim] = val_value; }

inline void CImpactVariable::SetLimiter_Secondary(unsigned short val_var, su2double val_value) { Limiter_Secondary[val_var] = val_value; }

inline su2double **CImpactVariable::GetGradient_Secondary(void) { return Gradient_Secondary; }

inline su2double *CImpactVariable::GetLimiter_Secondary(void) { return Limiter_Secondary; }

inline void CImpactVariable::SetHarmonicBalance_Source(unsigned short val_var, su2double val_source) { HB_Source[val_var] = val_source; }

inline su2double CImpactVariable::GetHarmonicBalance_Source(unsigned short val_var) { return HB_Source[val_var]; }

inline su2double CImpactVariable::GetPreconditioner_Beta() { return Precond_Beta; }

inline void CImpactVariable::SetPreconditioner_Beta(su2double val_Beta) { Precond_Beta = val_Beta; }

inline void CImpactVariable::SetWindGust( su2double* val_WindGust) {
  for (unsigned short iDim = 0; iDim < nDim; iDim++)
    WindGust[iDim] = val_WindGust[iDim];}

inline su2double* CImpactVariable::GetWindGust() { return WindGust;}

inline void CImpactVariable::SetWindGustDer( su2double* val_WindGustDer) {
  for (unsigned short iDim = 0; iDim < nDim+1; iDim++)
    WindGustDer[iDim] = val_WindGustDer[iDim];}

inline su2double* CImpactVariable::GetWindGustDer() { return WindGustDer;}

inline su2double CImpactVariable::Get_BGSSolution_k(unsigned short iDim) { return Solution_BGS_k[iDim];}
