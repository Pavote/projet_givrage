...
public:
   ...
   * \param[in] config - Definition of the particular problem.
   */
  CImpactVariable(su2double val_density, su2double *val_velocity, su2double val_energy, unsigned short val_nDim,
                 unsigned short val_nvar, CConfig *config);
   ...
   * \param[in] config - Definition of the particular problem.
   */
  CImpactVariable(su2double *val_solution, unsigned short val_nDim, unsigned short val_nvar, CConfig *config);

  /*!
   * \brief Destructor of the class.
   */
  virtual ~CImpactVariable(void);
